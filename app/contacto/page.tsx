        ...
        <Reveal>
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            <a href="https://wa.me/595981772872" target="_blank" rel="noreferrer" className="h-13 min-h-[52px] px-7 rounded-full bg-coffee text-cream text-sm tracking-wide inline-flex items-center gap-2.5 hover:bg-cocoa transition">
              ...
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"><path d="M20.5 3.5A11 11 0 0 0 3.6 17.3L2 22l4.9-1.5A11 11 0 1 0 20.5 3.5Z"/></svg>
            </a>
